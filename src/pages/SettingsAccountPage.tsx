    ...
    <div className="min-h-screen" style={{ backgroundColor: PAGE_BG }}>
      ...
      >
        <button
          ...
          className="mb-4 text-[13px] font-bold font-nunito"
        ...
        <p className="text-[13px] mt-1 font-nunito" style={{ color: 'rgba(255,255,255,0.65)' }}>
          Perfil, email e informações da conta
        </p>
      </div>
      ...
      <div className="px-4 pt-5">
        <div className="rounded-2xl p-5" style={{ backgroundColor: CARD_BG, border: `1px solid ${CARD_BORDER}` }}>
          ...
          <p className="text-[12px] mt-1.5 font-nunito leading-snug" style={{ color: TXT_MUTED }}>
            Aqui você poderá editar dados da conta e preferências pessoais.
          </p>
        </div>
      </div>
    </div>
