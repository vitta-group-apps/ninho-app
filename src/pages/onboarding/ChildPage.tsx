...
export default function ChildPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setError('Não foi possível concluir a ação. Tente novamente em instantes.');
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              onFocus={e => {
                if (!childName.trim()) e.target.style.borderColor = '#C7B3C5';
              }}
              onBlur={e => {
                if (!childName.trim()) e.target.style.borderColor = 'transparent';
              }}
            />
          </div>
