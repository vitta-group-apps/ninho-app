          ...
          >
            ...
            {totalSec > 0 && (
              <div className="text-center mb-2">
                <p
                  className="text-[36px] font-bold tabular-nums font-quicksand leading-none"
                  style={{ color: FEED_COLOR }}
                >
                  {fmtDurationShort(totalSec)}
                </p>
                <p className="text-[11px] mt-1 text-muted-foreground font-nunito">duração total</p>
              </div>
            )}
            ...
            {(leftSec > 0 || rightSec > 0) && (
              <div className="flex gap-2 mt-3">
                {[
                  ...
                  { label: 'Trocas', value: String(switches), color: 'hsl(var(--foreground))' },
                  { label: 'Direito', value: fmtDurationShort(rightSec), color: 'hsl(var(--primary))' },
                ].map(s => (
                  <div
                    key={s.label}
                  ...
                  >
                    <p className="text-[9px] font-bold uppercase tracking-wide text-muted-foreground font-nunito">
                      {s.label}
                    </p>
                    <p
                      className="text-[16px] font-bold font-quicksand mt-0.5"
                      style={{ color: s.color }}
                    >
                      {s.value}
                    </p>
