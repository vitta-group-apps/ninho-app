...
export function SummaryMetricCard({
  ...
  return (
    <div className="flex-1 min-w-0 rounded-2xl px-3 pt-3.5 pb-3 flex flex-col gap-1 bg-card overflow-hidden">
      {/* Icon + label row */}
      ...
      <p
        className={`text-[32px] font-bold leading-none font-quicksand min-w-0 ${empty ? 'opacity-30' : 'text-foreground'}`}
