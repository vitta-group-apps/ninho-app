...
function OTPScreen({ email, onBack }: { email: string; onBack: () => void }) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#806e84', minHeight: '100vh' }}
    >
      ...
      >
        ...
        <button
          onClick={onBack}
          className="relative z-10 flex items-center gap-1.5 mb-6 text-sm font-semibold"
          style={{
        ...
        <h2
          className="relative z-10 text-[22px] font-bold text-white mb-1.5"
      ...
      <div className="flex-1 px-6 pt-6 pb-10" style={{ backgroundColor: '#F8F5F0' }}>
        ...
        {error && (
          <div
            className="mb-4 px-3 py-2.5 rounded-xl text-xs font-medium text-center"
            style={{
...
export default function AuthPage() {
    ...
    try {
      ...
      if (msg.includes('Invalid login credentials')) {
        ...
        if (tab === 'signup') {
          ...
          setError(
            'Seu e-mail ainda não foi confirmado. Verifique sua caixa de entrada ou crie uma nova conta.'
          );
        }
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#F8F5F0' }}>
      {/* ── Header roxo ── */}
      <div
        className="relative overflow-hidden flex-shrink-0 px-6 pt-12 pb-8 text-center"
        style={{ backgroundColor: '#806e84', borderRadius: '0 0 28px 28px' }}
      >
        {/* Grain */}
        <div
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p
            className="mt-1 text-[13px] text-primary-foreground"
            style={{
              color: 'rgba(255,255,255,0.55)',
              fontFamily: 'Nunito, sans-serif',
              lineHeight: 1.5,
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => {
                  touch('email');
                  if (!emailError) e.target.style.borderColor = 'transparent';
                }}
              />
