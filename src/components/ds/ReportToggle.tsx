 ...
 *
 * Polish v2.1:
 * - Removed flat bg-card look — now has a subtle tinted background
 * - Icon added for visual anchoring
 * - More breathing room inside the row
 * - Shared across ALL routine forms
 */
