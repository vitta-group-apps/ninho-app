    ...
    extend: {
      ...
      colors: {
        ...
        "ds-accent": {
          ...
          "border-pressed": "var(--color-accent-border-border-subtle-pressed)",
        },
        "ds-secondary": {
          subtle:      "var(--color-secundary-background-bg-subtle-01)",
          "subtle-2":  "var(--color-secundary-background-bg-subtle-02)",
          "bg-hover":  "var(--color-secundary-background-bg-subtle-hover)",
          "bg-pressed":"var(--color-secundary-background-bg-subtle-pressed)",
          ...
          "border-hover":   "var(--color-secundary-border-border-subtle-hover)",
          "border-pressed": "var(--color-secundary-border-border-subtle-pressed)",
        },
        "ds-neutral": {
          ...
          "border-pressed": "var(--color-neutral-border-border-subtle-pressed)",
        },
        "ds-success": {
          subtle:           "var(--color-success-background-bg-subtle-01)",
          "subtle-2":       "var(--color-success-background-bg-subtle-02)",
          "bg-hover":       "var(--color-success-background-bg-subtle-hover)",
          "bg-pressed":     "var(--color-success-background-bg-subtle-pressed)",
          ...
          "border-hover":   "var(--color-success-border-border-subtle-hover)",
          "border-pressed": "var(--color-success-border-border-subtle-pressed)",
        },
        "ds-warning": {
          subtle:           "var(--color-warning-background-bg-subtle-01)",
          "subtle-2":       "var(--color-warning-background-bg-subtle-02)",
          "bg-hover":       "var(--color-warning-background-bg-subtle-hover)",
          "bg-pressed":     "var(--color-warning-background-bg-subtle-pressed)",
          tint:             "var(--color-warning-background-bg-tint-01)",
          "tint-dark":      "var(--color-warning-background-bg-tint-02)",
          ...
          "border-hover":   "var(--color-warning-border-border-subtle-hover)",
          "border-pressed": "var(--color-warning-border-border-subtle-pressed)",
        },
        "ds-error": {
          subtle:           "var(--color-error-background-bg-subtle-01)",
          "subtle-2":       "var(--color-error-background-bg-subtle-02)",
          "bg-hover":       "var(--color-error-background-bg-subtle-hover)",
          "bg-pressed":     "var(--color-error-background-bg-subtle-pressed)",
          ...
          "border-hover":   "var(--color-error-border-border-subtle-hover)",
          "border-pressed": "var(--color-error-border-border-subtle-pressed)",
        },
        "ds-info": {
          subtle:           "var(--color-info-background-bg-subtle-01)",
          "subtle-2":       "var(--color-info-background-bg-subtle-02)",
          "bg-hover":       "var(--color-info-background-bg-subtle-hover)",
          "bg-pressed":     "var(--color-info-background-bg-subtle-pressed)",
          ...
          "border-hover":   "var(--color-info-border-border-subtle-hover)",
          "border-pressed": "var(--color-info-border-border-subtle-pressed)",
        },
        "ds-on-tint": {
          white:        "var(--color-on-tint-white-fg-high-contrast)",
          "white-soft": "var(--color-on-tint-white-fg-low-contrast)",
          black:        "var(--color-on-tint-black-fg-high-contrast)",
          "black-soft": "var(--color-on-tint-black-fg-low-contrast)",
        },
        "ds-pure": {
        ...
        "ds-overlay": {
          "black-50":  "var(--color-overlays-overlay-black-50)",
          "black-100": "var(--color-overlays-overlay-black-100)",
          "black-200": "var(--color-overlays-overlay-black-200)",
          "black-400": "var(--color-overlays-overlay-black-400)",
          "black-500": "var(--color-overlays-overlay-black-500)",
          "white-50":  "var(--color-overlays-overlay-white-50)",
          "white-100": "var(--color-overlays-overlay-white-100)",
          "white-200": "var(--color-overlays-overlay-white-200)",
          "white-400": "var(--color-overlays-overlay-white-400)",
          "white-500": "var(--color-overlays-overlay-white-500)",
        },
      },
      spacing: {
        // DS spacing tokens — usam --padding-* e --gap-* do tokens.css
        "ds-none": "var(--gap-none)",
        "ds-xxs":  "var(--gap-xxs)",
        "ds-xs":   "var(--gap-xs)",
        "ds-sm":   "var(--gap-sm)",
        "ds-md":   "var(--gap-md)",
